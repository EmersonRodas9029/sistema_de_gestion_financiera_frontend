...
const getDefaultNotifications = (): Notification[] => [
  { id: generateUniqueId('NOT'), type: 'goal', title: '¡Meta de ahorro alcanzada!', message: 'Has alcanzado el 50% de tu meta "Fondo de Emergencia".', timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(), read: false, archived: false, actionable: true, actionUrl: '/goals', actionLabel: 'Ver meta' },
  ...
  { id: generateUniqueId('NOT'), type: 'goal', title: 'Meta próxima a vencer', message: 'Tu meta "Vacaciones Europa" vence en 30 días.', timestamp: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(), read: true, archived: false, actionable: true, actionUrl: '/goals', actionLabel: 'Ver progreso' },
  ...
  { id: generateUniqueId('NOT'), type: 'success', title: '¡Meta completada!', message: '¡Felicidades! Has completado tu meta "Boda".', timestamp: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), read: true, archived: false, actionable: true, actionUrl: '/goals', actionLabel: 'Ver detalles' },
