      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-gray-100 p-4 rounded-xl">
          ...
          <div className="space-y-1 text-sm">
            <p><span className="font-medium">Admin:</span> admin@finansys.com / admin123</p>
            <p><span className="font-medium">Cliente:</span> cliente@finansys.com / cliente123</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="py-2 px-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2">
